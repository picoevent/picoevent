...
class PicoEventRestClient:
    ...
    def post_event(self, event_type_id: int, event_data: dict, user_id: int = None):
        request_obj = {"event_type_id": event_type_id,
                       "user_id": user_id,
    ...
    def get_event_types(self):
        ssl_context = ssl.SSLContext()
        ssl_context.load_default_certs()
        request_url = urljoin(self._endpoint + "/event-types/", self._api_key)
